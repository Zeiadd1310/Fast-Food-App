...
class AnimatedButton extends StatefulWidget {
  const AnimatedButton({required this.bottomBarCenterModel, Key? key})
    : super(key: key);
...
class AnimatedButtonState extends State<AnimatedButton> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.only(
        bottom: Dimens.bottomPaddingAnimatedButton,
      ),
      child: Align(
        ...
        child: GestureDetector(
          ...
          child: AnimatedContainer(
            duration: const Duration(
              milliseconds: Dimens.animationDurationNormal,
            ),
  ...
  void _showCenterButtons() {
    RenderBox renderBox =
        _floatingCenterButtonStateKey.currentContext?.findRenderObject()
            as RenderBox;
